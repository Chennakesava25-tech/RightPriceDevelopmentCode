...
// 		var app = angular.module('TMDealCreationAddContractorRoleApp', []);
		app.controller("TMDealCreationAddContractorRoleController", ['$scope','$http','$window', function($scope,$http,$window,$index) {
			$scope.Prev = function()
		    {   
...
<body ng-app="RightPriceApp" ng-controller="TMDealCreationAddContractorRoleController" >
  ...
  <fieldset ng-disabled="loading || showLoader">
    <div class="container">
        ...
        <div class="row marginBottom5px">
            <div class="col-sm-12">
                <h3 class="text-left">T&M  Deal Creation - Add Contractor Role</h3>
            </div>
        </div>	
        <div>
            <form class="form-inline" role="form" name="RateCard" id="RateCard">
				...
				<div id="includedRateCardStages" ng-include="'${contextPath}/Rightprice/DealCreationAddContractorRole.jsp'"></div>
	     	</form>
        </div>
    </div>
    </fieldset>
