...
<script src="${contextPath}/resources/js/RightPrice/fpDealCreationStaffingController.js"></script>
<script src="${contextPath}/resources/js/Services/fpDealStaffingService.js"></script>
<script src="${contextPath}/resources/js/Factory/WebServiceFactory.js"></script>
</head>
<body ng-app="RightPriceApp" ng-controller="FPDealCreationStaffingController" >
   ...
   <fieldset ng-disabled="loading || showLoader">
    <div class="container">
        ...
        <div class="row marginBottom5px">
            <div class="col-sm-12">
                <h3 class="text-left"  id="PageHeading">FP Deal Creation - Staffing</h3>
            </div>
        </div>	
        <div>
            <form class="form-inline" role="form" name="frmFpDealStaffing" id="frmFpDealStaffing">
            	...
            	<div id="includedRateCardStages" ng-include="'${contextPath}/Rightprice/DealCreationStaffing.jsp'"></div>
	      	</form>
        </div>
    </div>
    </fieldset>
