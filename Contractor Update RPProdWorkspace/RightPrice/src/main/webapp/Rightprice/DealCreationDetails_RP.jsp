...
<script src="${contextPath}/resources/js/RightPrice/DealCreationDetails_RP_V2.js"></script>
<script src="${contextPath}/resources/js/Factory/WebServiceFactory.js"></script>
  
</head>
<body ng-app="RightPriceApp" ng-controller="DealCreationDetailsController" ng-init="currentUser('<%=session.getAttribute("username")%>')">
<%-- <body ng-app="RightPriceApp" ng-controller="TMDealCreationDetailsController" ng-init="currentUser('<%=org.springframework.security.core.context.SecurityContextHolder.getContext().getAuthentication().getName()%>')"> --%>
    ...
    <div class="container">
        ...
        <div class="row marginBottom5px">
            <div class="col-sm-12">
                <h3 class="text-left" id="PageHeading">Deal Creation - Details</h3>
            </div>
        </div>
        <div>
       ...
       <%--  <div id="includedT&PStages" ng-include="'${contextPath}/Portal/T&MdealCompletionStage.jsp'"></div>  --%>
             		<div id="DealCreationDetails" ng-include="'${contextPath}/Rightprice/innerTMDealCreationDetails_RP.jsp'"></div>
	      	</form>
        </div>
    </div>
    </fieldset>
