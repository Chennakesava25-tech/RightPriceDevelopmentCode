...
// 		var app = angular.module('TMDealCreationTeamDetailsApp', []);
		app.controller("TMDealCreationTeamDetailsController", ['$scope','$http','$window', function($scope,$http,$window,$index) {
			 $scope.Prev = function()
		    {   
...
<body ng-app="RightPriceApp" ng-controller="TMDealCreationTeamDetailsController" >
    ...
    <div class="container">
        ...
        <div class="row marginBottom5px">
            <div class="col-sm-12">
                <h3 class="text-left">T&M Deal Creation - Team Details</h3>
            </div>
        </div>	
        <div>
            <form class="form-inline" role="form" name="TeamDeal" id="TeamDeal">
            	 ...
            	 <div id="includedRateCardStages" ng-include="'${contextPath}/Rightprice/DealCreationInformationTable.jsp'"></div>
        	 	 <div id="includedRateCardStages" ng-include="'${contextPath}/Rightprice/DealCreationTeamDetails.jsp'"></div>         
	     	</form>
        </div>
    </div>
     </fieldset>
