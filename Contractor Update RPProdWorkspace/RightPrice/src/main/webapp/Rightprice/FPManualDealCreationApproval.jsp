...
<head>
	...
	<script src="${contextPath}/resources/js/RightPrice/fpManualDealCreationApproval.js"></script>
...
<body ng-app="RightPriceApp" ng-controller="FPCreationManualDealApprovalController">
...
<fieldset ng-disabled="loading || showLoader">
    <div class="container">
        ...
        <div class="row marginBottom5px">
            <div class="col-sm-12">
                <h3 class="text-left">FP Manual Deal Creation - Finalize Approval</h3>
            </div>
        </div>	
        <div>
            <form class="form-inline" role="form" name="RateCard" id="RateCard">
				...
				<div id="includedRateCardStages" ng-include="'${contextPath}/Rightprice/DealCreationManualApproval.jsp'"></div>
	      	</form>
        </div>
    </div>
     </fieldset>
