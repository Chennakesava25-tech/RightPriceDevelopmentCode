...
<head>
	...
	<script src="${contextPath}/resources/js/RightPrice/TMDealCreationFinaliseDeal.js"></script>
	<script src="${contextPath}/resources/js/Factory/WebServiceFactory.js"></script>
    <script type="text/javascript">
    </script>
</head>
<body ng-app="RightPriceApp" ng-controller="MapRolesToClientRoleController" >
...
<fieldset ng-disabled="loading || showLoader">
    <div class="container">
        ...
        <div class="row marginBottom5px">
            <div class="col-sm-12">
                <h3 class="text-left">T&M Deal Creation - Finalise Deal</h3>
            </div>
        </div>	
        <div>
            <form class="form-inline" role="form" name="teamDeal" id="teamDeal" novalidate>
				<div id="includedRateCardStages" ng-include="'${contextPath}/Portal/T&MdealCompletionStage.jsp'"></div>
				<div id="includedRateCardStages" ng-include="'${contextPath}/Rightprice/DealCreationT&MInformationTable.jsp'"></div>
				<div id="includedRateCardStages" ng-include="'${contextPath}/Rightprice/DealCreationFinaliseDeal.jsp'"></div>
	       	</form>
        </div>
    </div>
    </fieldset>
