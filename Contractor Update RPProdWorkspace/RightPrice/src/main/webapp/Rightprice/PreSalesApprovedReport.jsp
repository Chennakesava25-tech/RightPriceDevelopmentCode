...
<html lang="en">
<head>
    <title>Syntel RightPrice Portal</title>
<meta charset="utf-8">
...
<script src="${contextPath}/resources/js/RightPrice/PresalesApprovedReport.js"></script>
							...
							<div class="panel-group">
								<div class="panel panel-info ">
									...
									<div class="panel-body">
										<div class="row marginBottom5px">
												<label
													class="control-label col-sm-2 textAlignRight">Opportunity Id</label>
												<div class="col-sm-3">
													<input type="text" class="form-control" id="txtOpportunityId"
														name="txtOpportunityId"
														ng-model="PreSalesReport.opportunityId"
														ng-class="{true: 'ng-border'}[saved && PreSalesReport.txtOpportunityId.$invalid]">
													<div class="error-messages" ng-if="saved"
														ng-messages="PreSalesReport.txtRateCardStartDate.$error">
														<em class="error help-block has-error"
															ng-message="required">Opportunity Id is required!</em> <em
															class="error help-block has-error" ng-message="pattern">Opportunity Id is invalid!</em>
													</div>
												</div>
												<label 
													class="control-label col-sm-3 textAlignRight required-Field">Start Date<br>(dd/mm/yyyy) </label>
												<div class="col-sm-3">
													<input type="text" class="form-control customDate"
														placeholder="dd/mm/yyyy" id="txtPresalesStartDate"
														name="txtPresalesStartDate"
														ng-model="PreSalesReport.startdate"
														ng-change="calApplicableYears(PreSalesReport.startdate,PreSalesReport.enddate);"
														ng-class="{true: 'ng-border'}[saved && PreSalesReport.txtPresalesStartDate.$invalid]"
													...
													<div class="error-messages" ng-if="saved"
														ng-messages="PreSalesReport.txtPresalesStartDate.$error">
														<em class="error help-block has-error"
											...
											<div class="row marginBottom5px">
												<label 
													class="control-label col-sm-2 textAlignRight required-Field">End
													Date<br>(dd/mm/yyyy) </label>
												<div class="col-sm-3">
													<input type="text" class="form-control customDate"
														placeholder="dd/mm/yyyy" id="txtPresalesCardEndDate"
														name="txtPresalesCardEndDate"
														ng-model="PreSalesReport.enddate"
														ng-change="calApplicableYears(PreSalesReport.startdate,PreSalesReport.enddate);"
														ng-class="{true: 'ng-border'}[saved && PreSalesReport.txtPresalesCardEndDate.$invalid]"
														ng-pattern="/^(((0[1-9]|[12]\d|3[01])\/(0[13578]|1[02])\/((19|[2-9]\d)\d{2}))|((0[1-9]|[12]\d|30)\/(0[13456789]|1[012])\/((19|[2-9]\d)\d{2}))|((0[1-9]|1\d|2[0-8])\/02\/((19|[2-9]\d)\d{2}))|(29\/02\/((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))))$/i">
													<div class="error-messages" ng-if="saved"
														ng-messages="PreSalesReport.txtPresalesCardEndDate.$error">
														<em class="error help-block has-error"
											...
											<div class="col-sm-12">		
												<button type="button" class="btn btn-primary btnSpace" id="btnViewSearch" ng-disabled="btnDisable" ng-click="searchDataOnId();">Search</button>
				...
				<div class="row">
					...
					<div class="panel-group">
								<div class="panel panel-info ">
									<div class="panel-heading panelHeadingStyle">
										<div class="row ">
											<label class="control-label col-sm-10">PreSales Report</label>
										</div>
									</div>
							<div class="card-body">
									...
									<table
										...
										<thead>
											<tr>
												...
												<th class="tdMinWidth120">B&PS Approved BID Budget</th>
												<th class="tdMinWidth120">1st Level Approver Comments</th>
												<th class="tdMinWidth120">1st Level Approval Date</th>
												<th class="tdMinWidth120">2nd Level Approver Comments</th>
												<th class="tdMinWidth120">Budget Approval Date</th>
										...
										<tbody id="tBody">
											<tr ng-repeat="row in filteredItems">
												<td>{{($index+1)}}</td>
												...
												<td>{{row.bPSApprovedBIDBudget}}</td>
												<td>{{row.level1ApprovalComments}}</td>
												<td>{{row.level1ApprovalDate}}</td>
												<td>{{row.level2ApprovalComments}}</td>
												<td>{{row.level2ApprovalDate}}</td>
						...
						<div class="row marginBottom5px">
							<div class="col-md-12" style="color:#6ab5d5;">
								<h3 class="text-center">PreSales Report</h3>
							</div>
						</div>
						<div class="col-md-12">
						...
						<div class="row text-center">
										<div class="col-sm-12">
											<button type="button" class="btn btn-primary btnSpace"
												id="btnDetailsSave" ng-disabled="isDisabledReport"
