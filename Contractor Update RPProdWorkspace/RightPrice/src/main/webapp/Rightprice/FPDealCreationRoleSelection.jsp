...
<script src="${contextPath}/resources/js/RightPrice/FPDealCreationRoleSelection.js"></script>
...
<body ng-app="RightPriceApp" ng-controller="FPDealCreationRoleSelectionController">
...
<fieldset ng-disabled="loading || showLoader">
    <div class="container">
        ...
        <div class="row marginBottom5px">
            <div class="col-sm-12">
                <h3 class="text-left" id="PageHeading">FP Deal Creation - Role Selection</h3>
            </div>
        </div>	
        <div>
            <ng-form class="form-inline" role="form" name="fpdcRoleSelectionFrm" id="fpdcRoleSelectionFrm" novalidate>
            	...
            	<div id="includedRateCardStages" ng-include="'${contextPath}/Rightprice/DealCreationRoleSelection.jsp'"></div>
	         </ng-form>
        </div>
    </div>
     </fieldset>
