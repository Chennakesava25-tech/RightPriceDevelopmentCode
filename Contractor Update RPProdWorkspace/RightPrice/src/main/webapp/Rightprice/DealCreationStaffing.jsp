		...
		<div class="panel-group">
			<div class="panel panel-info ">
				<div class="panel-heading panelHeadingStyle"
					ng-click="ShowHideDealStaffingDetails()">
					<div class="row ">
				...
				<div class="panel-body" ng-hide="DealStaffingDetailsHidden">
					...
					<div class="row marginBottom5px">
						...
						<div class="col-sm-2">
							<select id="ddlDealStaffingDetailsTower" class="form-control"
								placeholder="Please select" name="ddlDealStaffingDetailsTower"
								ng-model="frmStaffing.dealStaffingDetailsTowerModel"
								ng-options="to as to.towerName for to in towerdetails"
								ng-change="getTowerCountryCity(frmStaffing.dealStaffingDetailsTowerModel)"
								required>
						...
						<div class="col-sm-2">
							<input id="ddlDealStaffingDetailsCountry" class="form-control"
								placeholder="Country" name="ddlDealStaffingDetailsCountry"
								ng-model="frmStaffing.dealStaffingDetailsCountryModel" disabled>
						...
						<div class="col-sm-2">
							<input id="ddlDealStaffingDetailsCity" class="form-control"
								placeholder="City" name="ddlDealStaffingDetailsCity"
								ng-model="frmStaffing.dealStaffingDetailsCityModel" disabled>
							</input>
						</div>
					...
					<div class="row text-center">
						<div class="col-sm-12">
							<button type="button" class="btn btn-primary btnSpace"
								id="btnSearch" ng-click="getFpDealStaffingData(frmStaffing)" ng-disabled="disabledflag1" >Search</button>
						</div>
					</div>
					<div class="divEmptyThrice"></div>
					<div class="row">
						...
						<p style="color: green"><b>
							Transistion Period = <input name="transGMPerModel" type="text"
								ng-value="showTransValue" style="width: 14px; border: none"
								id="transGMPerModel" ng-model="teamDeal.transGMPerModel"
								readonly> months marked in Green Color
								</b>
						</p>
						...
						<div class="col-sm-12">
							...
							<div class="table-responsive">
								<table id="tblStaffing"
									class="table tblDealCre table-borderless table-condensed">
									<thead>
										<tr class="">
											<th class="thWidth22Per thBorder">Master Skill</th>
											...
											<th class="colRightSection" colspan="16">
												<!-- <a class="btn btn-default ancBtnWidthSum" href="#">Summary</a> -->
												...
												<a ng-repeat="year in yearHeader" class="btn btn-default"
												href="#" style="margin-right: 5px;"
												ng-click="setYearHeader(year)" ng-show="year.year">{{year.year
													| limitTo:(year.year.length - (year.year.indexOf(","))-1)}}</a>
											</th>
										</tr>
									...
									<tbody>
										...
										<tr class=""
											ng-if="monthHeader.length > 0 &&  summaryFlag.length==0"
											bgcolor="#000000" ng-show='onsiteContractor.length > 0'>
											<td colspan="5" style="color: #ffffff"><strong>Onsite
													- Local(Contractor)</strong></td>
											<td class="thWidth4Per" ng-repeat="month in monthHeader"
												ng-style="{'color': colors[$index]}" style="color: #ffffff">{{month.month}}</td>
											<td class="thWidth4Per" style="color: #ffffff">Total</td>
										</tr>

										<tr class="sectionHeading" ng-if="summaryFlag.length==1"
											ng-show='onsiteContractor.length > 0'>
											<td colspan="18"><strong>Onsite -
													Local(Contractor)</strong></td>
										</tr>
									</tbody>
									...
									<tbody>
										<tr ng-repeat="data  in onsiteContractor"
											...
											<td class="colRightSection thWidth4Per"><input
												...
												getOtherData('onsiteContractor','onsiteLocal_Contractor','onsiteLocal_ContrSumTotal','onsiteSumTotalContractor','onsiteGross','onsiteGrossSumTotal','totalStaffingContr','totalSumTotalStaffing','staffingGross','staffingGrossSumTotal',data.masterRoleId,data.staffingFirstMonthCount,onsiteContractor,$index,'staffingFirstMonthCount'); "></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control"
												...
												getOtherData('onsiteContractor','onsiteLocal_Contractor','onsiteLocal_ContrSumTotal','onsiteSumTotalContractor','onsiteGross','onsiteGrossSumTotal','totalStaffingContr','totalSumTotalStaffing','staffingGross','staffingGrossSumTotal',data.masterRoleId,data.staffingSecondMonthCount,onsiteContractor,$index,'staffingSecondMonthCount');"></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control"
												...
												getOtherData('onsiteContractor','onsiteLocal_Contractor','onsiteLocal_ContrSumTotal','onsiteSumTotalContractor','onsiteGross','onsiteGrossSumTotal','totalStaffingContr','totalSumTotalStaffing','staffingGross','staffingGrossSumTotal',data.masterRoleId,data.staffingThirdMonthCount,onsiteContractor,$index,'staffingThirdMonthCount'); "></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control"
												...
												getOtherData('onsiteContractor','onsiteLocal_Contractor','onsiteLocal_ContrSumTotal','onsiteSumTotalContractor','onsiteGross','onsiteGrossSumTotal','totalStaffingContr','totalSumTotalStaffing','staffingGross','staffingGrossSumTotal',data.masterRoleId,data.staffingFourthMonthCount,onsiteContractor,$index,'staffingFourthMonthCount'); "></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control"
												...
												getOtherData('onsiteContractor','onsiteLocal_Contractor','onsiteLocal_ContrSumTotal','onsiteSumTotalContractor','onsiteGross','onsiteGrossSumTotal','totalStaffingContr','totalSumTotalStaffing','staffingGross','staffingGrossSumTotal',data.masterRoleId,data.staffingFifthMonthCount,onsiteContractor,$index,'staffingFifthMonthCount'); "></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control"
												...
												getOtherData('onsiteContractor','onsiteLocal_Contractor','onsiteLocal_ContrSumTotal','onsiteSumTotalContractor','onsiteGross','onsiteGrossSumTotal','totalStaffingContr','totalSumTotalStaffing','staffingGross','staffingGrossSumTotal',data.masterRoleId,data.staffingSixthMonthCount,onsiteContractor,$index,'staffingSixthMonthCount'); "></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control"
												...
												getOtherData('onsiteContractor','onsiteLocal_Contractor','onsiteLocal_ContrSumTotal','onsiteSumTotalContractor','onsiteGross','onsiteGrossSumTotal','totalStaffingContr','totalSumTotalStaffing','staffingGross','staffingGrossSumTotal',data.masterRoleId,data.staffingSeventhMonthCount,onsiteContractor,$index,'staffingSeventhMonthCount');"></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control"
												...
												getOtherData('onsiteContractor','onsiteLocal_Contractor','onsiteLocal_ContrSumTotal','onsiteSumTotalContractor','onsiteGross','onsiteGrossSumTotal','totalStaffingContr','totalSumTotalStaffing','staffingGross','staffingGrossSumTotal',data.masterRoleId,data.staffingEighthMonthCount,onsiteContractor,$index,'staffingEighthMonthCount'); "></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control"
												...
												getOtherData('onsiteContractor','onsiteLocal_Contractor','onsiteLocal_ContrSumTotal','onsiteSumTotalContractor','onsiteGross','onsiteGrossSumTotal','totalStaffingContr','totalSumTotalStaffing','staffingGross','staffingGrossSumTotal',data.masterRoleId,data.staffingNinthMonthCount,onsiteContractor,$index,'staffingNinthMonthCount');"></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control"
												...
												getOtherData('onsiteContractor','onsiteLocal_Contractor','onsiteLocal_ContrSumTotal','onsiteSumTotalContractor','onsiteGross','onsiteGrossSumTotal','totalStaffingContr','totalSumTotalStaffing','staffingGross','staffingGrossSumTotal',data.masterRoleId,data.staffingTenthMonthCount,onsiteContractor,$index,'staffingTenthMonthCount'); "></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control"
												...
												getOtherData('onsiteContractor','onsiteLocal_Contractor','onsiteLocal_ContrSumTotal','onsiteSumTotalContractor','onsiteGross','onsiteGrossSumTotal','totalStaffingContr','totalSumTotalStaffing','staffingGross','staffingGrossSumTotal',data.masterRoleId,data.staffingEleventhMonthCount,onsiteContractor,$index,'staffingEleventhMonthCount'); "></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control"
												...
												getOtherData('onsiteContractor','onsiteLocal_Contractor','onsiteLocal_ContrSumTotal','onsiteSumTotalContractor','onsiteGross','onsiteGrossSumTotal','totalStaffingContr','totalSumTotalStaffing','staffingGross','staffingGrossSumTotal',data.masterRoleId,data.staffingTwelthMonthCount,onsiteContractor,$index,'staffingTwelthMonthCount');"></td>
											<td class="colRightSection thWidth4Per"><input
									...
									<!--   <tbody>
					                              	<tr class="rowSubTotal" ng-repeat="data  in onsiteSumTotalContractor" ng-if="currentMonthYearHeader == data.monthYearHeader" >
					                          			<td colspan="4"><strong>1 .SUB TOTAL</strong></td>	                                    
									...
									<tbody>
										<tr class=""
											ng-if="monthHeader.length > 0 &&  summaryFlag.length==0"
											bgcolor="#000000">
											<td colspan="5" style="color: #ffffff"><strong>{{fpDealStaffing.onsiteLocalLabel}}</strong></td>
											<td class="thWidth4Per" ng-repeat="month in monthHeader"
												ng-style="{'color': colors[$index]}" style="color: #ffffff">{{month.month}}</td>
											<td class="thWidth4Per" style="color: #ffffff">Total</td>
										</tr>
									...
									<tbody>
											<tr  ng-repeat ="data  in onsiteLocal" ng-if="currentMonthYearHeader == data.monthYearHeader && data.isContractor == 0 && summaryFlag.length ==0">
					                          			<td id="{{'ddlDescription'+'_'+($index+1)}}" class="thWidth22Per colSection" ><input type="text" class="form-control" ng-model="data.masterRoles.masterRoleShortDescription" disabled></td>
					                                    <td id="{{'ddlCustomerRole'+'_'+($index+1)}}" class="thWidth8Per colSection"><input type="text" class="form-control" ng-model="data.customerRole" disabled></td>
					                                    <td id="{{'ddlBandGrade'+'_'+($index+1)}}" class="thWidth15Per colSection"><input type="text" class="form-control" ng-model="data.masterRoles.bandGrade" disabled></td>
					                                    <td class="thWidth15Per colSection"><input type="text" class="form-control" ng-model="data.masterRoles.gcmCODE"	disabled></td>
					                                    <td id="{{'ddlBillingRate'+'_'+($index+1)}}" class="thWidth8Per colSection"><input type="text" class="form-control" ng-model="data.stfaffingBilling_Rate" disabled></td>
										...
										<tr ng-repeat="data  in onsiteLocal"
											ng-if="currentMonthYearHeader == data.monthYearHeader && data.isContractor == 0 && summaryFlag.length ==1">
											<td class="thWidth22Per colSection"><input type="text"
												class="form-control"
												ng-model="data.masterRoles.masterRoleShortDescription"
												disabled></td>
											...
											<td class="colRightSection thWidth4Per"><input
												...
												ng-if="data.staffingFirstMonthCount != null"
												ng-model="data.staffingFirstMonthCount"
												ng-blur="calculateRowTotal('onsiteLocal',$index);  getLocal_Contr('onsiteLocal_Contractor','onsiteLocal_ContrSumTotal',$index,'staffingFirstMonthCount'); calculateSubTotal('onsiteLocal','onsiteLocalSumTotal','staffingFirstMonthCount');getTotalOnsite('onsiteTotal','onsiteSumTotal',$index,'staffingFirstMonthCount');   getOnsiteGross('onsiteGross','onsiteGrossSumTotal',$index,'staffingFirstMonthCount');  calculateTotalStaffing('totalStaffing',$index,'staffingFirstMonthCount','totalSumTotalStaffing'); getStaffingGross('staffingGross','staffingGrossSumTotal',$index,'staffingFirstMonthCount');  "
											...
											<td class="colRightSection thWidth4Per"><input
												...
												ng-blur="calculateRowTotal('onsiteLocal',$index); getLocal_Contr('onsiteLocal_Contractor','onsiteLocal_ContrSumTotal',$index,'staffingSecondMonthCount');  calculateSubTotal('onsiteLocal','onsiteLocalSumTotal','staffingSecondMonthCount');getTotalOnsite('onsiteTotal','onsiteSumTotal',$index,'staffingSecondMonthCount');getOnsiteGross('onsiteGross','onsiteGrossSumTotal',$index,'staffingSecondMonthCount');  calculateTotalStaffing('totalStaffing',$index,'staffingSecondMonthCount','totalSumTotalStaffing'); getStaffingGross('staffingGross','staffingGrossSumTotal',$index,'staffingSecondMonthCount');"
												disabled></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control"
												ng-if="data.staffingThirdMonthCount != null"
												...
												ng-blur="calculateRowTotal('onsiteLocal',$index);  getLocal_Contr('onsiteLocal_Contractor','onsiteLocal_ContrSumTotal',$index,'staffingThirdMonthCount'); calculateSubTotal('onsiteLocal','onsiteLocalSumTotal','staffingThirdMonthCount');getTotalOnsite('onsiteTotal','onsiteSumTotal',$index,'staffingThirdMonthCount');   getOnsiteGross('onsiteGross','onsiteGrossSumTotal',$index,'staffingThirdMonthCount');calculateTotalStaffing('totalStaffing',$index,'staffingThirdMonthCount','totalSumTotalStaffing'); getStaffingGross('staffingGross','staffingGrossSumTotal',$index,'staffingThirdMonthCount');"
												disabled></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control"
												ng-if="data.staffingFourthMonthCount != null"
												...
												ng-blur="calculateRowTotal('onsiteLocal',$index); getLocal_Contr('onsiteLocal_Contractor','onsiteLocal_ContrSumTotal',$index,'staffingFourthMonthCount');  calculateSubTotal('onsiteLocal','onsiteLocalSumTotal','staffingFourthMonthCount');getTotalOnsite('onsiteTotal','onsiteSumTotal',$index,'staffingFourthMonthCount');getOnsiteGross('onsiteGross','onsiteGrossSumTotal',$index,'staffingFourthMonthCount');calculateTotalStaffing('totalStaffing',$index,'staffingFourthMonthCount','totalSumTotalStaffing'); getStaffingGross('staffingGross','staffingGrossSumTotal',$index,'staffingFourthMonthCount');"
												disabled></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control"
												ng-if="data.staffingFifthMonthCount != null"
												...
												ng-blur="calculateRowTotal('onsiteLocal',$index);  getLocal_Contr('onsiteLocal_Contractor','onsiteLocal_ContrSumTotal',$index,'staffingFifthMonthCount'); calculateSubTotal('onsiteLocal','onsiteLocalSumTotal','staffingFifthMonthCount');getTotalOnsite('onsiteTotal','onsiteSumTotal',$index,'staffingFifthMonthCount'); getOnsiteGross('onsiteGross','onsiteGrossSumTotal',$index,'staffingFifthMonthCount');calculateTotalStaffing('totalStaffing',$index,'staffingFifthMonthCount','totalSumTotalStaffing'); getStaffingGross('staffingGross','staffingGrossSumTotal',$index,'staffingFifthMonthCount');"
												disabled></td>
											...
											<td class="colRightSection thWidth4Per"><input
												...
												ng-blur="calculateRowTotal('onsiteLocal',$index);  getLocal_Contr('onsiteLocal_Contractor','onsiteLocal_ContrSumTotal',$index,'staffingSixthMonthCount'); calculateSubTotal('onsiteLocal','onsiteLocalSumTotal','staffingFifthMonthCount');getTotalOnsite('onsiteTotal','onsiteSumTotal',$index,'staffingSixthMonthCount'); getOnsiteGross('onsiteGross','onsiteGrossSumTotal',$index,'staffingSixthMonthCount');calculateTotalStaffing('totalStaffing',$index,'staffingFifthMonthCount','totalSumTotalStaffing'); getStaffingGross('staffingGross','staffingGrossSumTotal',$index,'staffingSixthMonthCount');"
												disabled></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control"
												ng-if="data.staffingSeventhMonthCount != null"
												...
												ng-blur="calculateRowTotal('onsiteLocal',$index);  getLocal_Contr('onsiteLocal_Contractor','onsiteLocal_ContrSumTotal',$index,'staffingSeventhMonthCount'); calculateSubTotal('onsiteLocal','onsiteLocalSumTotal','staffingSeventhMonthCount');getTotalOnsite('onsiteTotal','onsiteSumTotal',$index,'staffingSeventhMonthCount');   getOnsiteGross('onsiteGross','onsiteGrossSumTotal',$index,'staffingSeventhMonthCount');  calculateTotalStaffing('totalStaffing',$index,'staffingSeventhMonthCount','totalSumTotalStaffing'); getStaffingGross('staffingGross','staffingGrossSumTotal',$index,'staffingSeventhMonthCount'); "
												disabled></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control"
												ng-if="data.staffingEighthMonthCount != null"
												...
												ng-model="data.staffingEighthMonthCount"
												ng-blur="calculateRowTotal('onsiteLocal',$index); getLocal_Contr('onsiteLocal_Contractor','onsiteLocal_ContrSumTotal',$index,'staffingEighthMonthCount');  calculateSubTotal('onsiteLocal','onsiteLocalSumTotal','staffingEighthMonthCount');getTotalOnsite('onsiteTotal','onsiteSumTotal',$index,'staffingEighthMonthCount');getOnsiteGross('onsiteGross','onsiteGrossSumTotal',$index,'staffingEighthMonthCount');  calculateTotalStaffing('totalStaffing',$index,'staffingEighthMonthCount','totalSumTotalStaffing'); getStaffingGross('staffingGross','staffingGrossSumTotal',$index,'staffingEighthMonthCount');"
												disabled></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control"
												ng-if="data.staffingNinthMonthCount != null"
												...
												ng-model="data.staffingNinthMonthCount"
												ng-blur="calculateRowTotal('onsiteLocal',$index);  getLocal_Contr('onsiteLocal_Contractor','onsiteLocal_ContrSumTotal',$index,'staffingNinthMonthCount'); calculateSubTotal('onsiteLocal','onsiteLocalSumTotal','staffingNinthMonthCount');getTotalOnsite('onsiteTotal','onsiteSumTotal',$index,'staffingNinthMonthCount');   getOnsiteGross('onsiteGross','onsiteGrossSumTotal',$index,'staffingNinthMonthCount');calculateTotalStaffing('totalStaffing',$index,'staffingTenthMonthCount','totalSumTotalStaffing'); getStaffingGross('staffingGross','staffingGrossSumTotal',$index,'staffingNinthMonthCount');"
												disabled></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control"
												ng-if="data.staffingTenthMonthCount != null"
									...
									<!-- <tbody>
					                              	...
					                              	<tr class="rowSubTotal" ng-repeat="data  in onsiteLocalSumTotal" ng-if="currentMonthYearHeader == data.monthYearHeader " >
					                          			<td colspan="4"><strong>2. SUB TOTAL</strong></td>	                                    
					                                    <td class="thWidth4Per"><input type="text" class="form-control" ng-if="data.staffingFirstMonthCount != null" ng-model="data.staffingFirstMonthCount" disabled></td>
					                                    <td class="thWidth4Per"><input type="text" class="form-control" ng-if="data.staffingSecondMonthCount != null" ng-model="data.staffingSecondMonthCount" disabled></td>
					                                    <td class="thWidth4Per"><input type="text" class="form-control" ng-if="data.staffingThirdMonthCount != null" ng-model="data.staffingThirdMonthCount" disabled></td>
					                                    <td class="thWidth4Per"><input type="text" class="form-control" ng-if="data.staffingFourthMonthCount != null" ng-model="data.staffingFourthMonthCount" disabled></td>
									...
									<tbody>
										...
										<tr class="rowSubTotal"
											ng-repeat="data  in onsiteLocal_ContrSumTotal"
											ng-if="currentMonthYearHeader == data.monthYearHeader  && summaryFlag.length==0">
											<td colspan="5"><strong>1. TOTAL (Local/Deputed (Landed))</strong></td>
											<td class="thWidth4Per"><input type="text"
												class="form-control"
												ng-if="data.staffingFirstMonthCount != null"
												ng-model="data.staffingFirstMonthCount" disabled></td>
											<td class="thWidth4Per"><input type="text"
												class="form-control"
												ng-if="data.staffingSecondMonthCount != null"
												ng-model="data.staffingSecondMonthCount" disabled></td>
											<td class="thWidth4Per"><input type="text"
												class="form-control"
												ng-if="data.staffingThirdMonthCount != null"
												ng-model="data.staffingThirdMonthCount" disabled></td>
											<td class="thWidth4Per"><input type="text"
												class="form-control"
												ng-if="data.staffingFourthMonthCount != null"
												ng-model="data.staffingFourthMonthCount" disabled></td>
											<td class="thWidth4Per"><input type="text"
												class="form-control"
												ng-if="data.staffingFifthMonthCount != null"
												ng-model="data.staffingFifthMonthCount" disabled></td>
											<td class="thWidth4Per"><input type="text"
												class="form-control"
												ng-if="data.staffingSixthMonthCount != null"
												ng-model="data.staffingSixthMonthCount" disabled></td>
											<td class="thWidth4Per"><input type="text"
												class="form-control"
												ng-if="data.staffingSeventhMonthCount != null"
												ng-model="data.staffingSeventhMonthCount" disabled></td>
											<td class="thWidth4Per"><input type="text"
												class="form-control"
												ng-if="data.staffingEighthMonthCount != null"
												ng-model="data.staffingEighthMonthCount" disabled></td>
											<td class="thWidth4Per"><input type="text"
												class="form-control"
												ng-if="data.staffingNinthMonthCount != null"
												ng-model="data.staffingNinthMonthCount" disabled></td>
											<td class="thWidth4Per"><input type="text"
												class="form-control"
												ng-if="data.staffingTenthMonthCount != null"
												ng-model="data.staffingTenthMonthCount" disabled></td>
											<td class="thWidth4Per"><input type="text"
												class="form-control"
												ng-if="data.staffingEleventhMonthCount != null"
												ng-model="data.staffingEleventhMonthCount" disabled></td>
											<td class="thWidth4Per"><input type="text"
												class="form-control"
												ng-if="data.staffingTwelthMonthCount != null"
												ng-model="data.staffingTwelthMonthCount" disabled></td>
											<td class="thWidth4Per"><input type="text"
												class="form-control" ng-model="data.yearlyTotal" disabled></td>
										</tr>

										<tr class="rowSubTotal"
											ng-repeat="data  in onsiteLocal_ContrSumTotal"
											ng-if="currentMonthYearHeader == data.monthYearHeader  && summaryFlag.length==1 ">
											<td colspan="5"><strong>1. TOTAL (Local/Deputed (Landed) )</strong></td>
											<td class="thWidth4Per"><input type="text"
												class="form-control"
												ng-if="data.staffingFirstMonthCount != null"
									...
									<!-- <tbody>
										<tr class=""
											ng-if="monthHeader.length > 0 &&  summaryFlag.length==0"
											bgcolor="#000000">
											<td colspan="5" style="color: #ffffff"><strong>{{fpDealStaffing.onsiteDeputedLabel}}</td>
											<td class="thWidth4Per" ng-repeat="month in monthHeader"
												ng-style="{'color': colors[$index]}" style="color: #ffffff">{{month.month}}</td>
											<td class="thWidth4Per" style="color: #ffffff">Total</td>
										</tr>
									...
									<tbody>
										...
										<tr ng-repeat="data  in onsiteDeputed"
											ng-if="currentMonthYearHeader == data.monthYearHeader  && summaryFlag.length==1 ">
											<td class="thWidth22Per colSection"><input type="text"
												class="form-control"
												ng-model="data.masterRoles.masterRoleShortDescription"
									...
									<tbody> 
										<tr class="rowSubTotal"
											ng-repeat="data  in onsiteDeputedSumTotal"
											ng-if="currentMonthYearHeader == data.monthYearHeader && summaryFlag.length==0 ">
											<td colspan="5"><strong>2. TOTAL (Deputed -
													Long term)</strong></td>
											<td class="thWidth4Per"><input type="text"
												class="form-control"
												ng-if="data.staffingFirstMonthCount != null"
									...
									<tbody>
										<tr class=""
											ng-if="monthHeader.length > 0 &&  summaryFlag.length==0"
											bgcolor="#000000" ng-show='onsiteShortTerm.length > 0'>
											<td colspan="5" style="color: #ffffff"><strong>{{fpDealStaffing.onsiteShortTermLabel}}</strong></td>
											<td class="thWidth4Per" ng-repeat="month in monthHeader"
												ng-style="{'color': colors[$index]}" style="color: #ffffff">{{month.month}}</td>
											<td class="thWidth4Per" style="color: #ffffff">Total</td>
										</tr>
										<tr class="sectionHeading" ng-if="summaryFlag.length==1"
											ng-show='onsiteShortTerm.length > 0'>
									...
									<tbody>
										<tr ng-repeat="data  in onsiteShortTerm"
											...
											<td class="thWidth22Per colSection"><input type="text"
												...
												disabled></td>
											<td class="thWidth8Per colSection"><input type="text"
												class="form-control" ng-model="data.customerRole" ng-disabled="shortTermDisabled" disabled></td>
											<td class="thWidth15Per colSection"><input type="text"
												class="form-control" ng-model="data.masterRoles.bandGrade"
												ng-disabled="shortTermDisabled"
												disabled></td>
										...
										<tr ng-repeat="data  in onsiteShortTerm"
											...
											<td class="thWidth22Per colSection"><input type="text"
												...
												disabled></td>
											<td class="thWidth8Per colSection"><input type="text"
												class="form-control" ng-model="data.customerRole" 
												ng-disabled="shortTermDisabled"  disabled></td>
											<td class="thWidth15Per colSection"><input type="text"
												class="form-control" ng-model="data.masterRoles.bandGrade"
												disabled></td>
											<td class="thWidth15Per colSection"><input type="text"
									...
									<tbody>
										<tr class="rowSubTotal"
											ng-repeat="data  in onsiteShortTermSumTotal"
											ng-if="currentMonthYearHeader == data.monthYearHeader && summaryFlag.length==0">
											<td colspan="5"><strong>2 .TOTAL (Short term (Business visa))</strong></td>
											<td class="thWidth4Per"><input type="text"
												class="form-control"
												ng-if="data.staffingFirstMonthCount != null"
												ng-model="data.staffingFirstMonthCount" disabled></td>
									...
									<tbody>
										<tr class=""
											ng-if="monthHeader.length > 0 &&  summaryFlag.length==0"
											bgcolor="#000000">
											<td colspan="5" style="color: #ffffff"><strong>
													<!-- Total Onsite --> {{fpDealStaffing.onsiteTotalLabel}}
											</strong></td>
											<td class="thWidth4Per" ng-repeat="month in monthHeader"
												ng-style="{'color': colors[$index]}" style="color: #ffffff">{{month.month}}</td>
											<td class="thWidth4Per" style="color: #ffffff">Total</td>
										...
										<tr class="sectionHeading" ng-if="summaryFlag.length==1">
											<td colspan="18"><span class="text-white"><strong>{{fpDealStaffing.onsiteTotalLabel}}</strong></span></td>
										</tr>
									</tbody>
									<tbody>
										<tr ng-repeat="data  in onsiteContractor"
											ng-if="currentMonthYearHeader == data.monthYearHeader  && data.isContractor == 1 ">
											<td class="thWidth22Per colSection"><input type="text"
												class="form-control"
												ng-model="data.masterRoles.masterRoleShortDescription"
												disabled></td>
										...
										<tr ng-repeat="data  in onsiteTotal"
									...
									<tbody>
										<tr class="rowSubTotal" ng-repeat="data  in onsiteSumTotal"
											ng-if="currentMonthYearHeader == data.monthYearHeader && summaryFlag.length==0">
											<td colspan="5"><strong>3. SUB TOTAL (1+2)
													Onsite</strong></td>
											<td class="thWidth4Per"><input type="text"
												class="form-control"
												ng-if="data.staffingFirstMonthCount != null"
									...
									<!-- <tbody>
					                              	<tr class="rowSubTotal" ng-repeat="data  in onsiteGrossSumTotal" ng-if="currentMonthYearHeader == data.monthYearHeader" >	                          			
					                                    <td colspan="4"><strong>5. SUB TOTAL(onsiteGrossSumTotal)</strong></td>	                                    
					                                    <td class="thWidth4Per"><input type="text" class="form-control" ng-if="data.staffingFirstMonthCount != null" ng-model="data.staffingFirstMonthCount" disabled></td>
					                                    <td class="thWidth4Per"><input type="text" class="form-control" ng-if="data.staffingSecondMonthCount != null" ng-model="data.staffingSecondMonthCount" disabled></td>
					                                    <td class="thWidth4Per"><input type="text" class="form-control" ng-if="data.staffingThirdMonthCount != null" ng-model="data.staffingThirdMonthCount" disabled></td>
					                                    <td class="thWidth4Per"><input type="text" class="form-control" ng-if="data.staffingFourthMonthCount != null" ng-model="data.staffingFourthMonthCount" disabled></td>
									...
									<tbody>
										<tr class=""
											ng-if="monthHeader.length > 0 &&  summaryFlag.length==0"
											bgcolor="#000000" ng-show='offshoreTotalContr.length > 0'>
											<td colspan="5" style="color: #ffffff"><strong>OffShore
													Contractor </strong></td>
											<td class="thWidth4Per" ng-repeat="month in monthHeader"
												ng-style="{'color': colors[$index]}" style="color: #ffffff">{{month.month}}</td>
											<td class="thWidth4Per" style="color: #ffffff">Total</td>
										</tr>
										<tr class="sectionHeading" ng-if="summaryFlag.length==1"
											ng-show='offshoreTotalContr.length > 0'>
											<td colspan="18"><span class="text-white"><strong>OffShore
														Contractor </strong></span></td>
										</tr>
									</tbody>
									<tbody>
										...
										<tr ng-repeat ="data  in offshoreTotalContr" ng-if="currentMonthYearHeader == data.monthYearHeader && data.isContractor == 1 && summaryFlag.length==1 " >					                              		
		                          			<td class="thWidth22Per colSection" ><input type="text" class="form-control" ng-model="data.masterRoles.masterRoleShortDescription" disabled></td>
		                                    <td class="thWidth8Per colSection"><input type="text" class="form-control" ng-model="data.customerRole" disabled></td>
		                                    <td class="thWidth15Per colSection"><input type="text" class="form-control" ng-model="data.masterRoles.bandGrade" disabled></td>
		                                    <td class="thWidth8Per colSection"><input type="text" class="form-control" ng-model="data.masterRoles.gcmCODE" disabled></td>
		                                    <td class="thWidth8Per colSection"><input type="text" class="form-control" ng-model="data.stfaffingBilling_Rate" disabled></td>
		                                    <td class="colRightSection thWidth4Per"><input type="text" class="form-control" ng-if="data.staffingFirstMonthCount != null" ng-model="data.staffingFirstMonthCount" ng-blur="calculateRowTotal('offshoreTotalContr',$index); getLocal_Contr('offshore_Contractor','offshore_ContrSumTotal',$index,'staffingFirstMonthCount');  calculateSubTotal('offshoreTotalContr','offshoreSumTotalContr','staffingFirstMonthCount');calculateTotalStaffingContr('totalStaffingContr',$index,'staffingFirstMonthCount','totalSumTotalStaffing');getStaffingGross('staffingGross','staffingGrossSumTotal',$index,'staffingFirstMonthCount');" disabled></td>
		                                    ...
		                                    <td class="colRightSection thWidth4Per"><input type="text" class="form-control" ng-if="data.staffingEighthMonthCount != null" ng-model="data.staffingEighthMonthCount" ng-blur="calculateRowTotal('offshoreTotal',$index);getLocal_Contr('offshore_Contractor','offshore_ContrSumTotal',$index,'staffingEighthMonthCount');calculateSubTotal('offshoreTotal','offshoreSumTotal','staffingEighthMonthCount');calculateTotalStaffingContr('totalStaffingContr',$index,'staffingEighthMonthCount','totalSumTotalStaffing');getStaffingGross('staffingGross','staffingGrossSumTotal',$index,'staffingEighthMonthCount');" disabled></td>
		                                    <td class="colRightSection thWidth4Per"><input type="text" class="form-control" ng-if="data.staffingNinthMonthCount != null" ng-model="data.staffingNinthMonthCount" ng-blur="calculateRowTotal('offshoreTotal',$index);getLocal_Contr('offshore_Contractor','offshore_ContrSumTotal',$index,'staffingNinthMonthCount');calculateSubTotal('offshoreTotal','offshoreSumTotal','staffingNinthMonthCount');calculateTotalStaffingContr('totalStaffingContr',$index,'staffingNinthMonthCount','totalSumTotalStaffing');getStaffingGross('staffingGross','staffingGrossSumTotal',$index,'staffingNinthMonthCount');" disabled></td>
		                                    <td class="colRightSection thWidth4Per"><input type="text" class="form-control" ng-if="data.staffingTenthMonthCount != null" ng-model="data.staffingTenthMonthCount" ng-blur="calculateRowTotal('offshoreTotal',$index);getLocal_Contr('offshore_Contractor','offshore_ContrSumTotal',$index,'staffingTenthMonthCount');calculateSubTotal('offshoreTotal','offshoreSumTotal','staffingTenthMonthCount');calculateTotalStaffingContr('totalStaffingContr',$index,'staffingTenthMonthCount','totalSumTotalStaffing');getStaffingGross('staffingGross','staffingGrossSumTotal',$index,'staffingTenthMonthCount');" disabled></td>
		                                    <td class="colRightSection thWidth4Per"></td>
											<td class="colRightSection thWidth4Per"></td>
		                                    <td class="colRightSection thWidth4Per"><input type="text" class="form-control" ng-model="data.yearlyTotal" disabled></td>
		                              	</tr>
									...
									<tbody>
										<tr class=""
											ng-if="monthHeader.length > 0 &&  summaryFlag.length==0"
											bgcolor="#000000">
											<td colspan="5" style="color: #ffffff"><span
												class="text-white"><strong>{{fpDealStaffing.offshoreTotalLabel}}</strong></span></td>
											<td class="thWidth4Per" ng-repeat="month in monthHeader"
												ng-style="{'color': colors[$index]}" style="color: #ffffff">{{month.month}}</td>
											<td class="thWidth4Per" style="color: #ffffff">Total</td>
										</tr>
									...
									<!-- <tr ng-repeat="data  in offshoreTotal"
											...
											<td class="colRightSection thWidth4Per"><input
												...
												ng-if="data.staffingFirstMonthCount != null"
												ng-model="data.staffingFirstMonthCount"
												ng-blur="calculateRowTotal('offshoreTotal',$index); getLocal_Contr('offshore_Contractor','offshore_ContrSumTotal',$index,'staffingFirstMonthCount'); calculateSubTotal('offshoreTotal','offshoreSumTotal','staffingFirstMonthCount');  calculateTotalStaffing('totalStaffing',$index,'staffingFirstMonthCount','totalSumTotalStaffing'); getStaffingGross('staffingGross','staffingGrossSumTotal',$index,'staffingFirstMonthCount');"></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control"
												ng-if="data.staffingSecondMonthCount != null"
												ng-model="data.staffingSecondMonthCount"
												ng-blur="calculateRowTotal('offshoreTotal',$index);getLocal_Contr('offshore_Contractor','offshore_ContrSumTotal',$index,'staffingSecondMonthCount');calculateSubTotal('offshoreTotal','offshoreSumTotal','staffingSecondMonthCount');calculateTotalStaffing('totalStaffing',$index,'staffingSecondMonthCount','totalSumTotalStaffing'); getStaffingGross('staffingGross','staffingGrossSumTotal',$index,'staffingSecondMonthCount');"></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control"
												ng-if="data.staffingThirdMonthCount != null"
												ng-model="data.staffingThirdMonthCount"
												ng-blur="calculateRowTotal('offshoreTotal',$index);getLocal_Contr('offshore_Contractor','offshore_ContrSumTotal',$index,'staffingThirdMonthCount');calculateSubTotal('offshoreTotal','offshoreSumTotal','staffingThirdMonthCount');calculateTotalStaffing('totalStaffing',$index,'staffingThirdMonthCount','totalSumTotalStaffing'); getStaffingGross('staffingGross','staffingGrossSumTotal',$index,'staffingThirdMonthCount');"></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control"
												ng-if="data.staffingFourthMonthCount != null"
												ng-model="data.staffingFourthMonthCount"
												ng-blur="calculateRowTotal('offshoreTotal',$index);getLocal_Contr('offshore_Contractor','offshore_ContrSumTotal',$index,'staffingFourthMonthCount');calculateSubTotal('offshoreTotal','offshoreSumTotal','staffingFourthMonthCount');calculateTotalStaffing('totalStaffing',$index,'staffingFourthMonthCount','totalSumTotalStaffing'); getStaffingGross('staffingGross','staffingGrossSumTotal',$index,'staffingFourthMonthCount');"></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control"
												ng-if="data.staffingFifthMonthCount != null"
												ng-model="data.staffingFifthMonthCount"
												ng-blur="calculateRowTotal('offshoreTotal',$index);getLocal_Contr('offshore_Contractor','offshore_ContrSumTotal',$index,'staffingFifthMonthCount');calculateSubTotal('offshoreTotal','offshoreSumTotal','staffingFifthMonthCount');calculateTotalStaffing('totalStaffing',$index,'staffingFifthMonthCount','totalSumTotalStaffing'); getStaffingGross('staffingGross','staffingGrossSumTotal',$index,'staffingFifthMonthCount');"></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control"
												ng-if="data.staffingSixthMonthCount != null"
												ng-model="data.staffingSixthMonthCount"
											...
											<td class="colRightSection thWidth4Per"><input
												...
												ng-if="data.staffingSeventhMonthCount != null"
												ng-model="data.staffingSeventhMonthCount"
												ng-blur="calculateRowTotal('offshoreTotal',$index);getLocal_Contr('offshore_Contractor','offshore_ContrSumTotal',$index,'staffingSeventhMonthCount');calculateSubTotal('offshoreTotal','offshoreSumTotal','staffingSeventhMonthCount');calculateTotalStaffing('totalStaffing',$index,'staffingSeventhMonthCount','totalSumTotalStaffing'); getStaffingGross('staffingGross','staffingGrossSumTotal',$index,'staffingSeventhMonthCount');"></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control"
												ng-if="data.staffingEighthMonthCount != null"
												ng-model="data.staffingEighthMonthCount"
												ng-blur="calculateRowTotal('offshoreTotal',$index);getLocal_Contr('offshore_Contractor','offshore_ContrSumTotal',$index,'staffingEighthMonthCount');calculateSubTotal('offshoreTotal','offshoreSumTotal','staffingEighthMonthCount');calculateTotalStaffing('totalStaffing',$index,'staffingEighthMonthCount','totalSumTotalStaffing'); getStaffingGross('staffingGross','staffingGrossSumTotal',$index,'staffingEighthMonthCount');"></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control"
												ng-if="data.staffingNinthMonthCount != null"
												ng-model="data.staffingNinthMonthCount"
												ng-blur="calculateRowTotal('offshoreTotal',$index);getLocal_Contr('offshore_Contractor','offshore_ContrSumTotal',$index,'staffingNinthMonthCount');calculateSubTotal('offshoreTotal','offshoreSumTotal','staffingNinthMonthCount');calculateTotalStaffing('totalStaffing',$index,'staffingNinthMonthCount','totalSumTotalStaffing'); getStaffingGross('staffingGross','staffingGrossSumTotal',$index,'staffingNinthMonthCount');"></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control"
												ng-if="data.staffingTenthMonthCount != null"
												ng-model="data.staffingTenthMonthCount"
											...
											<td class="colRightSection thWidth4Per"><input
												...
												ng-if="data.staffingEleventhMonthCount != null"
												ng-model="data.staffingEleventhMonthCount"
												ng-blur="calculateRowTotal('offshoreTotal',$index);getLocal_Contr('offshore_Contractor','offshore_ContrSumTotal',$index,'staffingEleventhMonthCount');calculateSubTotal('offshoreTotal','offshoreSumTotal','staffingEleventhMonthCount');calculateTotalStaffing('totalStaffing',$index,'staffingEleventhMonthCount','totalSumTotalStaffing'); getStaffingGross('staffingGross','staffingGrossSumTotal',$index,'staffingEleventhMonthCount');"></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control"
												ng-if="data.staffingTwelthMonthCount != null"
												ng-model="data.staffingTwelthMonthCount"
												ng-blur="calculateRowTotal('offshoreTotal',$index);getLocal_Contr('offshore_Contractor','offshore_ContrSumTotal',$index,'staffingTwelthMonthCount'); calculateSubTotal('offshoreTotal','offshoreSumTotal','staffingTwelthMonthCount');calculateTotalStaffing('totalStaffing',$index,'staffingTwelthMonthCount','totalSumTotalStaffing'); getStaffingGross('staffingGross','staffingGrossSumTotal',$index,'staffingTwelthMonthCount');"></td>
											<td class="colRightSection thWidth4Per"><input
												type="text" class="form-control" ng-model="data.yearlyTotal"
												disabled></td>
										</tr> -->
									...
									<tbody>
										<!-- <tr class="rowSubTotal" ng-repeat="data  in offshoreSumTotal" ng-if="currentMonthYearHeader == data.monthYearHeader" >	                          			
					                                    <td colspan="4"><strong>6. SUB TOTAL</strong></td>	 
					                                    <td colspan="4"><strong>6. OffShore(Including Contractor) TOTAL</strong></td>	                                   
					                                    <td class="thWidth4Per"><input type="text" class="form-control" ng-if="data.staffingFirstMonthCount != null" ng-model="data.staffingFirstMonthCount" disabled></td>
					                                    <td class="thWidth4Per"><input type="text" class="form-control" ng-if="data.staffingSecondMonthCount != null" ng-model="data.staffingSecondMonthCount" disabled></td>
					                                    <td class="thWidth4Per"><input type="text" class="form-control" ng-if="data.staffingThirdMonthCount != null" ng-model="data.staffingThirdMonthCount" disabled></td>
					                                    <td class="thWidth4Per"><input type="text" class="form-control" ng-if="data.staffingFourthMonthCount != null" ng-model="data.staffingFourthMonthCount" disabled></td>
										...
										<tr class="rowSubTotal"
											ng-repeat="data  in offshore_ContrSumTotal"
											ng-if="currentMonthYearHeader == data.monthYearHeader && summaryFlag.length==0">

											<td colspan="5"><strong>4.Total OffShore
													(Including Contractor) </strong></td>
											<td class="thWidth4Per"><input type="text"
												class="form-control"
												ng-if="data.staffingFirstMonthCount != null"
												ng-model="data.staffingFirstMonthCount" disabled></td>
									...
									<tbody>
										<tr class=""
											ng-if="monthHeader.length > 0 &&  summaryFlag.length==0"
											bgcolor="#000000">
											<td colspan="5" style="color: #ffffff"><strong>4.SUB
													Total Staffing</strong></td>
											<td class="thWidth4Per" ng-repeat="month in monthHeader"
												ng-style="{'color': colors[$index]}" style="color: #ffffff">{{month.month}}</td>
											<td class="thWidth4Per" style="color: #ffffff">Total</td>
										</tr>
										<tr class="sectionHeading" ng-if="summaryFlag.length==1">
											<td colspan="18"><span class="text-white"><strong>SUB
														Total Staffing</strong></span></td>
										</tr>
									</tbody>
									<tbody>
										<tr ng-repeat="data  in totalStaffingContr"
											ng-if="currentMonthYearHeader == data.monthYearHeader && data.isContractor == 1  && summaryFlag.length==0">
											<td class="thWidth22Per colSection"><input type="text"
												class="form-control"
												ng-model="data.masterRoles.masterRoleShortDescription"
										...
										<tr ng-repeat="data  in totalStaffingContr"
											ng-if="currentMonthYearHeader == data.monthYearHeader && data.isContractor == 1  && summaryFlag.length==1">
											<td class="thWidth22Per colSection"><input type="text"
												class="form-control"
												ng-model="data.masterRoles.masterRoleShortDescription"
												disabled></td>
											...
											<td class="colRightSection thWidth4Per"><input type="text"
												class="form-control"
												ng-if="data.staffingSixthMonthCount != null"
												ng-model="data.staffingSixthMonthCount" disabled></td>
											<td class="colRightSection thWidth4Per"><input type="text"
										...
										<tr ng-repeat="data  in totalStaffing"
											ng-if="currentMonthYearHeader == data.monthYearHeader && data.isContractor == 0   && summaryFlag.length==0 ">
											<td class="thWidth22Per colSection"><input type="text"
												class="form-control"
												ng-model="data.masterRoles.masterRoleShortDescription"
									...
									<tbody>
										<tr class="rowSubTotal"
											ng-repeat="data  in totalSumTotalStaffing"
											ng-if="currentMonthYearHeader == data.monthYearHeader   && summaryFlag.length==0 ">
											<td colspan="5"><strong>5. SUB Total Staffing
													(3+4)</strong></td>
											<td class="thWidth4Per"><input type="text"
												class="form-control"
												ng-if="data.staffingFirstMonthCount != null"
										...
										<!--  <tr class="rowSubTotal" ng-repeat="data  in totalSumTotalStaffing1" ng-if="currentMonthYearHeader == data.monthYearHeader" >	                          			
					                                    <td colspan="4"><strong>7. SUB TOTAL</strong></td>	                                    
					                                    <td class="thWidth4Per"><input type="text" class="form-control" ng-if="data.staffingFirstMonthCount != null" ng-model="data.staffingFirstMonthCount" disabled></td>
					                                    <td class="thWidth4Per"><input type="text" class="form-control" ng-if="data.staffingSecondMonthCount != null" ng-model="data.staffingSecondMonthCount" disabled></td>
					                                    <td class="thWidth4Per"><input type="text" class="form-control" ng-if="data.staffingThirdMonthCount != null" ng-model="data.staffingThirdMonthCount" disabled></td>
					                                    <td class="thWidth4Per"><input type="text" class="form-control" ng-if="data.staffingFourthMonthCount != null" ng-model="data.staffingFourthMonthCount" disabled></td>
										...
										<!-- 	<tr class="rowSubTotal" ng-repeat="data  in staffingGrossSumTotal" ng-if="currentMonthYearHeader == data.monthYearHeader" >	                          			
					                                    <td colspan="4"><strong>7.1. SUB TOTAL</strong></td>	                                    
					                                    <td class="thWidth4Per"><input type="text" class="form-control" ng-if="data.staffingFirstMonthCount != null" ng-model="data.staffingFirstMonthCount" disabled></td>
					                                    <td class="thWidth4Per"><input type="text" class="form-control" ng-if="data.staffingSecondMonthCount != null" ng-model="data.staffingSecondMonthCount" disabled></td>
					                                    <td class="thWidth4Per"><input type="text" class="form-control" ng-if="data.staffingThirdMonthCount != null" ng-model="data.staffingThirdMonthCount" disabled></td>
					                                    <td class="thWidth4Per"><input type="text" class="form-control" ng-if="data.staffingFourthMonthCount != null" ng-model="data.staffingFourthMonthCount" disabled></td>
									...
									<tbody>
										<tr class="rowSubTotal" ng-repeat="data  in onsiteSumTotal"
											...
											<td width="5%">
												<table
													class="table tblDealCre table-borderless table-condensed">
													<tr ng-repeat="datat  in totalSumTotalStaffing"
														ng-if="currentMonthYearHeader == datat.monthYearHeader && summaryFlag.length==0">
														<td width="5%"><input type="text"
															class="form-control"
															ng-model="data.staffingFirstMonthCount*100/datat.staffingFirstMonthCount | number : 2"
															disabled></td>
													</tr>
											...
											<td width="5%">
												<table
													...
													<tr ng-repeat="datat  in totalSumTotalStaffing"
														...
														<td width="5%"><input type="text"
															class="form-control"
															ng-model="data.staffingSecondMonthCount*100/datat.staffingSecondMonthCount | number : 2"
															disabled></td>
													</tr>
											...
											<td width="5%">
												<table
													...
													<tr ng-repeat="datat  in totalSumTotalStaffing"
														...
														<td width="5%"><input type="text"
															class="form-control"
															ng-model="data.staffingThirdMonthCount*100/datat.staffingThirdMonthCount | number : 2"
															disabled></td>
													</tr>
											...
											<td width="5%">
												<table
													...
													<tr ng-repeat="datat  in totalSumTotalStaffing"
														...
														<td width="5%"><input type="text"
															class="form-control"
															ng-model="data.staffingFourthMonthCount*100/datat.staffingFourthMonthCount | number : 2"
															disabled></td>
													</tr>
											...
											<td width="5%">
												<table
													...
													<tr ng-repeat="datat  in totalSumTotalStaffing"
														...
														<td width="5%"><input type="text"
															class="form-control"
															ng-model="data.staffingFifthMonthCount*100/datat.staffingFifthMonthCount | number : 2"
															disabled></td>
													</tr>
											...
											<td width="5%">
												<table
													...
													<tr ng-repeat="datat  in totalSumTotalStaffing"
														...
														<td width="5%"><input type="text"
															class="form-control"
															ng-model="data.staffingSixthMonthCount*100/datat.staffingSixthMonthCount | number : 2"
															disabled></td>
													</tr>
											...
											<td width="5%">
												<table
													...
													<tr ng-repeat="datat  in totalSumTotalStaffing"
														...
														<td width="5%"><input type="text"
															class="form-control"
															ng-model="data.staffingSeventhMonthCount*100/datat.staffingSeventhMonthCount | number : 2"
															disabled></td>
													</tr>
											...
											<td width="5%">
												<table
													...
													<tr ng-repeat="datat  in totalSumTotalStaffing"
														...
														<td width="5%"><input type="text"
															class="form-control"
															ng-model="data.staffingEighthMonthCount*100/datat.staffingEighthMonthCount | number : 2"
															disabled></td>
													</tr>
											...
											<td width="5%">
												<table
													...
													<tr ng-repeat="datat  in totalSumTotalStaffing"
														...
														<td width="5%"><input type="text"
															class="form-control"
															ng-model="data.staffingNinthMonthCount*100/datat.staffingNinthMonthCount | number : 2"
															disabled></td>
													</tr>
											...
											<td width="5%">
												<table
													...
													<tr ng-repeat="datat  in totalSumTotalStaffing"
														...
														<td width="5%"><input type="text"
															class="form-control"
															ng-model="data.staffingTenthMonthCount*100/datat.staffingTenthMonthCount | number : 2"
															disabled></td>
													</tr>
											...
											<td width="5%">
												<table
													...
													<tr ng-repeat="datat  in totalSumTotalStaffing"
														...
														<td width="5%"><input type="text"
															class="form-control"
															ng-model="data.staffingEleventhMonthCount*100/datat.staffingEleventhMonthCount | number : 2"
															disabled></td>
													</tr>
												</table>
											</td>
											<td width="5%">
												<table
													...
													<tr ng-repeat="datat  in totalSumTotalStaffing"
														...
														<td width="5%"><input type="text"
															class="form-control"
															ng-model="data.staffingTwelthMonthCount*100/datat.staffingTwelthMonthCount | number : 2"
															disabled></td>
													</tr>
												</table>
											</td>
											...
											<td width="5%">
												<table
													...
													<tr ng-repeat="datat  in totalSumTotalStaffing"
														...
														<td width="5%"><input type="text"
															class="form-control"
															ng-model="data.yearlyTotal*100/datat.yearlyTotal | number : 2"
															disabled></td>
													</tr>
										...
										<tr class="rowSubTotal" ng-repeat="data  in onsiteSumTotal"
											...
											<td width="5%">
												<table
													class="table tblDealCre table-borderless table-condensed">
													<tr ng-repeat="datat  in totalSumTotalStaffing"
														ng-if="currentMonthYearHeader == datat.monthYearHeader && summaryFlag.length==1">
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="panel-group"
										ng-show='staffingContactorRoleList.length > 0'>
										<div class="panel panel-info ">
											<ng-form name="dealCreationAddContractorRoleForm"
												id="dealCreationAddContractorRoleForm">
											<div class="panel-heading panelHeadingStyle">
												<div class="row ">
													<label class="control-label col-sm-10 ">Add
													...
													<div class="col-sm-12">
														<div class="table-responsive  ">
															<table
																...
																id="tblAddContractor">
																<thead>
																	<tr ng-show='staffingContactorRoleList.length > 0'>
																		<th>Sr.No.</th>
																		<th>Customer Role</th>
																		<th>Onsite Rate</th>
																...
																<tbody id="tBodyAddContractor">
																	<tr id="{{'traddContactorRole'+'_'+($index+1)}}"
																		ng-repeat="row in staffingContactorRoleList">
																		...
																		<td><input
																			name="{{'txtcontactorRole'+'_'+($index+1)}}"
																			type="text" class="form-control" value="{{$index+1}}"
																			id="{{'txtSrNo'+'_'+($index+1)}}" disabled></td>

																		<td><input
																			name="{{'txtcontactorRole'+'_'+($index+1)}}"
																			ng-model="row.customerRole" type="text"
																			class="form-control" id="txtcontactorRole" disabled></td>

																		<td><input
																			name="{{'txtonsiteRate'+'_'+($index+1)}}"
																			ng-model="row.onsiteRate" type="text"
																			class="form-control" id="txtonsiteRate"></td>

																		<td><input
																			name="{{'txtonsiteCost'+'_'+($index+1)}}"
																			ng-model="row.onsiteCost" type="text"
																			class="form-control" id="txtonsiteCost"></td>

																		<td><input
																			name="{{'txtoffshoreRate'+'_'+($index+1)}}"
																			ng-model="row.offshoreRate" type="text"
																			class="form-control" id="txtoffshoreRate"></td>
																		<td><input
																			name="{{'txtoffshoreCost'+'_'+($index+1)}}"
																			ng-model="row.offshoreCost" type="text"
																			class="form-control" id="txtoffshoreCost"></td>
																		<!-- 
					...
					<!-- <div class="divEmptyThrice"></div>
                                <div class="row text-center">
									<div class="col-sm-12">	
										<button type="button" class="btn btn-primary btnSpace" id="btnCalculate" ng-click="save()">Save</button>
		...
		<div class="panel-group">
			<div class="panel panel-info ">
				<div class="panel-heading panelHeadingStyle"
					...
					<div class="row ">
						<label class="control-label col-sm-10 ">Upload Deal
							Staffing Excel</label>
						<div class="col-sm-2 textAlignRight">
							<label class="DownArrowColor textAlignRight"> &#9660;</label>
						</div>
					</div>
				...
				<div class="panel-body" ng-hide="UploadHidden">
					<div class="row marginBottom5px">
						...
						<div class="col-sm-3 ">
							<input type="file" class="form-control" name="fuAttachFilename"
								id="fuAttachFilename"
								ng-model="frmFpDealStaffing.fuAttachFilenameModel"
								ng-class="{true: 'ng-border'}[(upload) && frmFpDealStaffing.fuAttachFilename.$invalid]">
						</div>
						<label class="control-label col-sm-3 textAlignRight">Excel
							sheet</label>
						<div class="col-sm-3 ">
							<input type="button" class="btn btn-primary"
								value="Download Template" id="btnDownloadTemplate" ng-click ="getRolesExcel(frmFpDealStaffing);"
					...
					<div class="row text-center">
						<div class="col-sm-12">
							<button type="button" class="btn btn-primary btnSpace"
								id="btnUpload"
								ng-click="updateStaffingAttachment(frmFpDealStaffing);"
...
<div class="row text-center">
	<div class="col-sm-12">
		...
		<button class="btn btn-primary btnSpace" type="button"
			ng-click="exportToExcel()" ng-disabled="isDownloadEnabled">
			<img src="/RightPrice/resources/Images/downloadexcel.png" alt="Snow">
			Export to Excel
		</button>
		<button type="button" class="btn btn-primary btnSpace"
			id="btnCalculate" ng-click="save()" ng-disabled="isSaveDisabled">Save</button>
		<button type="button" class="btn btn-danger btnSpace" id="btnIdClear"
...
<div class="divEmptyThrice"></div>
					<div class="row">
<marquee width="100%" direction="right" height="200px">
						<p style="color: green">
	
	
							<b>
						If contractor role is selected then Please click on save button Twice.
							</b>
						</p>
