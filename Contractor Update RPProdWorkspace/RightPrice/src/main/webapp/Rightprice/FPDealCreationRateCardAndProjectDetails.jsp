...
<meta http-equiv="X-UA-Compatible" content="IE=Edge" />
   <link href="${contextPath}/resources/css/bootstrap.css" rel="stylesheet" />
	...
	<script src="${contextPath}/resources/js/RightPrice/FPDealCreationRateCardAndProjectDetails.js"></script>
	<script src="${contextPath}/resources/js/Factory/WebServiceFactory.js"></script>
</head>
<body ng-app="RightPriceApp" ng-controller="FPDealCreationRateCardAndProjectDetailsController" >
   ...
   <fieldset ng-disabled="loading || showLoader">
    <div class="container">
        ...
        <div class="row marginBottom5px">
            <div class="col-sm-12">
                <h3 class="text-left">FP Deal Creation - Tower Details</h3>
            </div>
        </div>
        <div>
    		<form class="form-inline" role="form" name="RateCard" id="RateCard">
	      		...
	      		<div id="DealCreationRateCardAndProjectDetails" ng-include="'${contextPath}/Rightprice/DealCreationRateCardAndProjectDetails.jsp'"></div>
	     	</form>
    	</div>	
    </div>
    </fieldset>
