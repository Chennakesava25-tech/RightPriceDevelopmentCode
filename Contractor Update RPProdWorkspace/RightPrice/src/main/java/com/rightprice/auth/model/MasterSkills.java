...
@Entity
@ApiModel(value="App Code Skills",description="Skills Model Attributes")
@Table(name = "synprod.MST_RP_App_Code_Skills")
public class MasterSkills implements Serializable {
