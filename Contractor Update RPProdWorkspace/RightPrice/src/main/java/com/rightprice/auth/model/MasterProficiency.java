...
@Entity
@ApiModel(value="App Code Proficiency",description="Proficiency Model Attributes")
@Table(name = "synprod.MST_RP_App_Code_Proficiency")
public class MasterProficiency implements Serializable {
