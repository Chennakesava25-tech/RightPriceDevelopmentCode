...
@Entity
@ApiModel(value="appcode",description="Appcode Model Attributes")
@Table(name = "synprod.MST_RP_App_Code_Visa_Type") 
public class AppCodeVisaType  implements Serializable{
