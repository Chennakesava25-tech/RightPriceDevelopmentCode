...
@Table(name = "synprod.RP_Deal_FP_CPC_Revenue_Details")
public class CpcRevenueDetails {
	@Id
    @GeneratedValue(strategy = GenerationType.AUTO)
	@Column(name = "Cpc_Revenue_Details_Id")
	@ApiModelProperty(notes="Cpc Revenue Details Id")
