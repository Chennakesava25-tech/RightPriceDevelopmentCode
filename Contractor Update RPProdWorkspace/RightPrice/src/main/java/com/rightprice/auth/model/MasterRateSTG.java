...
@Entity
@ApiModel(value="Master Rate STG",description="Rate Model Attributes")
@Table(name = "synprod.MST_RP_Master_Rate_STG")
public class MasterRateSTG implements Serializable{
