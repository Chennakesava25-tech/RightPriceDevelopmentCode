...
@Entity
@ApiModel(value="cityCategorization",description="City Model Attributes")
@Table(name = "synprod.MST_RP_App_Code_City_Category") 
public class CityCategorization implements Serializable {
