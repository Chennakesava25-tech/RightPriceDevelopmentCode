...
@Entity
@ApiModel(value="synprod.RP_V2_RateCard_Attachment",description="synprod.RP_V2_RateCard_Attachment")
@Table(name = "synprod.RP_V2_RateCard_Attachment")

public class RateCardAttachment implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4309904751761309237L;
