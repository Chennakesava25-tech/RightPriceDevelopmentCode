...
@Entity
public class PersistedFpDealRoles 
{

	@Id
	@Column(name="FP_Deal_Role_Id")
	private int FP_Deal_Role_Id;
...
*/
	...
	public int getFP_Deal_Role_Id() {
		return FP_Deal_Role_Id;
	}

	public void setFP_Deal_Role_Id(int fP_Deal_Role_Id) {
		FP_Deal_Role_Id = fP_Deal_Role_Id;
	}
