...
@Entity
@Table(name = "[synprod].[RP_Deal_FP_Auto_Year_Data_STG]")
public class RPDealFPAutoYearDataSTG 
{
	@Id
    @GeneratedValue(strategy = GenerationType.AUTO)
	@Column(name = "[RP_Deal_FP_Auto_Year_Data_STG_Id")
	private Integer RPDealFPAutoYearDataSTGId;
	

	@Column(name = "Master_Role_Name")
	@ApiModelProperty(notes="Master RoleName")
	private String masterRoleName;

	@Column(name = "Client_Role")
	@ApiModelProperty(notes="ClientRole")
	...
	public Integer getRPDealFPAutoYearDataSTGId() {
		return RPDealFPAutoYearDataSTGId;
	}

	public void setRPDealFPAutoYearDataSTGId(Integer rPDealFPAutoYearDataSTGId) {
		RPDealFPAutoYearDataSTGId = rPDealFPAutoYearDataSTGId;
	}
