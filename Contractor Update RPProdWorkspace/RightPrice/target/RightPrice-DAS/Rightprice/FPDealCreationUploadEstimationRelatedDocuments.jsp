...
<head>
	...
	<script src="${contextPath}/resources/js/RightPrice/dealCreationUploadEstimationRelatedDocument.js"></script>
	<script src="${contextPath}/resources/js/Factory/WebServiceFactory.js"></script>
</head>
<body ng-app="RightPriceApp" ng-controller="FPDealCreationUploadDocumentsController" >
  ...
  <fieldset ng-disabled="loading || showLoader">
    <div class="container">
        ...
        <div class="row marginBottom5px">
            <div class="col-sm-12">
                <h3 class="text-left">FP Deal Creation - Upload Estimation Related Documents</h3>
            </div>
        </div>	
        <div>
            <form class="form-inline" role="form" name="TeamDeal" id="TeamDeal">
            	...
            	<div id="includedRateCardStages" ng-include="'${contextPath}/Rightprice/DealCreationUploadEstimationRelatedDocuments.jsp'"></div>
	        </form>
        </div>
    </div>
    </fieldset>
