...
<head>
	...
	<script src="${contextPath}/resources/js/RightPrice/fpDealPricingDetails.js"></script>
...
<body ng-app="RightPriceApp" ng-controller="FPDealPricingDetailsController" >
   ...
   <%--  <div id="includedT&PStages" ng-include="'${contextPath}/Portal/FPdealCompletionStage.jsp'"></div>
        ...
        <div class="row marginBottom5px">
            <div class="col-sm-12">
                <h3 class="text-left" id="PageHeading">FP Deal Creation - Pricing Details</h3>
            </div>
        </div>	
        <div>
...
<%-- 	              	<div id="includedT&PStages" ng-if="fpdealmanual" ng-include="'${contextPath}/Portal/FPdealManualCompletionStage.jsp'"></div> --%>
	           		<div id="FPDealPricingDetails" ng-include="'${contextPath}/Rightprice/FPDealPricingDetails.jsp'"></div>
	      	</form>
        </div>
    </div>
    </fieldset>
