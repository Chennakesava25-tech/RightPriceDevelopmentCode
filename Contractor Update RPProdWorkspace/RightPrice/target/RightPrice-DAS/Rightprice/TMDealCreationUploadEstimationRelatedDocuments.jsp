...
<head>
	...
	<script src="${contextPath}/resources/js/RightPrice/TMDealCreationUploadDocuments.js"></script>
	<script src="${contextPath}/resources/js/Factory/WebServiceFactory.js"></script>
</head>
<body ng-app="RightPriceApp" ng-controller="TMDealCreationUploadDocumentsController" >
   ...
   <fieldset ng-disabled="loading || showLoader">
    <div class="container">
        ...
        <div class="row marginBottom5px">
            <div class="col-sm-12">
                <h3 class="text-left">T&M Deal Creation - Upload Estimation Related Documents</h3>
            </div>
        </div>	
        <div>
