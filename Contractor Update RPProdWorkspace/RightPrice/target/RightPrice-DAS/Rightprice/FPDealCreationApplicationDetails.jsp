...
// 		var app = angular.module('FPDealCreationTowerDetailsApp', []);
		app.controller("FPDealCreationTowerDetailsController", ['$scope','$http','$window', function($scope,$http,$window,$index) {
			$scope.Prev = function() 
		    {   
...
<body ng-app="RightPriceApp" ng-controller="FPDealCreationTowerDetailsController" >
   ...
   <fieldset ng-disabled="loading || showLoader">
    <div class="container">
        ...
        <div>
            <form class="form-inline" role="form" name="TowerDeal" id="TowerDeal">
