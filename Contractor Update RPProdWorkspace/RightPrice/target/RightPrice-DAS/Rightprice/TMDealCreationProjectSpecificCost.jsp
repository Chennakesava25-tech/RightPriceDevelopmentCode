...
<head>
	...
	<script src="${contextPath}/resources/js/RightPrice/TMDealCreationProjectSpecificCost.js"></script>
	<script src="${contextPath}/resources/js/Factory/WebServiceFactory.js"></script>
    <script type="text/javascript">
    	
// 		var app = angular.module('TMDealCreationPFContractorCostApp ', []);
/*		app.controller("TMDealCreationPFContractorCostController", ['$scope','$location','$anchorScroll','$http','$window', function($scope,$location,$anchorScroll,$http,$window,$index) {
...
<body ng-app="RightPriceApp" ng-controller="TMDealCreationPFContractorCostController" >
...
<fieldset ng-disabled="loading || showLoader">
    <div class="container">
        ...
        <div class="row marginBottom5px">
            <div class="col-sm-12">
                <h3 class="text-left" id="PageHeading">T&M Deal Creation - Project Specific Cost</h3>
            </div>
        </div>	
        <div>
