...
<head>
	...
	<script src="${contextPath}/resources/js/RightPrice/fpDealCreationAddContractorRole.js"></script>
...
<body ng-app="RightPriceApp" ng-controller="FPDealCreationAddContractorRoleController" >
...
<fieldset ng-disabled="loading || showLoader">
    <div class="container">
        ...
        <div class="row marginBottom5px">
            <div class="col-sm-12">
                <h3 class="text-left">FP Deal Creation - Add Contractor Role</h3>
            </div>
        </div>	
        <div>
