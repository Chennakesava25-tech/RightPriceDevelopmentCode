...
<head>
	...
	<script src="${contextPath}/resources/js/loader.js"></script>
 	<script src="${contextPath}/resources/js/RightPrice/masterTaxParameters.js"></script>
...
<body ng-app="RightPriceApp" ng-controller="MasterTaxParametersController" >
    ...
    <div class="container">
        ...
        <div class="row marginBottom5px">
            <div class="col-sm-12">
                <h3 class="text-left" id="PageHeading">Master - Tax Parameters</h3>
            </div>
        </div>	
        <div>
						...
						<div class="panel-group">
							...
							<ng-form name="viewParameterForm" id="viewParameterForm" >
								<div class="panel-heading panelHeadingStyle"  ng-click="ShowHideViewCommonCostParameters()">
									<div class="row ">
										<label class="control-label col-sm-10 ">View Tax Parameter</label>
								...
								<div class="panel-body" ng-hide = "ViewCommonCostParametersHidden">
                                    ...
                                    <div class="row text-center">
										<div class="col-sm-12">
											<button type="button" class="btn btn-primary btnSpace" id="btnViewCommonCostSearch" ng-click="onTaxViewParameterForm(viewParameterForm.$valid,viewParameterForm.countryModel)">Search</button>	
<!-- 											<button type="button" class="btn btn-primary" id="btnDownloadViewCostParameter" ng-click = "getMasterTaxExcel();" ng-disabled= downloadBtn>Download Cost Parameter</button> -->
										</div>
									</div>
                                    <div class="divEmptyThrice"></div>
									<div class="row">
                            ...
                            <div class="panel panel-info ">
                             <ng-form name="updateParameterForm" id="updateParameterForm" >
                                <div class="panel-heading panelHeadingStyle" ng-click="ShowHideUpdateCommonCostParameter()">
                                    <div class="row ">
										<label class="control-label col-sm-10 ">Update Tax Parameter</label>
										<label class="DownArrowColor col-sm-2  textAlignRight"> &#9660;</label>
									</div>
                                </div>
                                <div class="panel-body" ng-hide = "UpdateCommonCostParameterHidden">
                                    ...
                                    <div class="row text-center">
										<div class="col-sm-12">
											<button type="button" class="btn btn-primary btnSpace" id="btnViewCommonCostSearch" ng-click="onUpdateTPSearch(updateParameterForm.$valid)">Search</button>	
										</div>
									</div>
									<div class="divEmptyThrice"></div>
	                                    ...
	                                    <div class="col-sm-12">
											<div >
												<table class="table clsTable table-striped table-bordered table-hover table-condensed">
													...
													<tbody>
														<tr id="{{'trAParamView'+'_'+($index+1)}}" ng-repeat="taxParamView in arrTaxParam">
															<td class="tdTextAlignLeft">{{taxParamView.taxMap.description}}</td>
															<td>
																<input name="{{'txtaddParcentageDed'+'_'+($index+1)}}" ng-model="taxParamView.parDeduction" 
                                    ...
                                    <div class="row text-center">
										<div class="col-sm-12">		
											<button type="button" class="btn btn-primary btnSpace" id="btnUpdateUpdate" ng-click="updateData(updateParameterForm.$valid)" ng-disabled="isUpdate" >Update</button>		
