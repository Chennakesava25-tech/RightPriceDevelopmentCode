...
<head>
	...
	<script src="${contextPath}/resources/js/RightPrice/FPDealCreationFinalize.js"></script>
...
<body ng-app="RightPriceApp" ng-controller="FPDealCreationFinalizeController">
...
<fieldset ng-disabled="loading || showLoader">
    <div class="container">
        ...
        <div class="row marginBottom5px">
            <div class="col-sm-12">
                <h3 class="text-left">FP Deal Creation - Finalize Deal</h3>
            </div>
        </div>	
        <div>
            <form class="form-inline" role="form" name="fpDealFinalize" id="fpDealFinalize">
				...
				<div id="includedRateCardStages" ng-include="'${contextPath}/Rightprice/DealCreationApprovalMatrix.jsp'"></div>
	      	</form>
        </div>
    </div>
 </fieldset>
