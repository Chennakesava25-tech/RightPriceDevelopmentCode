...
<head>
	...
	<script src="${contextPath}/resources/js/RightPrice/RoleMgmt.js"></script>
	<script src="${contextPath}/resources/js/Directives/angularCustomValidations.js"></script>
	<script src="${contextPath}/resources/js/Factory/RoleAngularService.js"></script>
	<script src="${contextPath}/resources/js/Factory/WebServiceFactory.js"></script>
</head>
<body ng-app="RightPriceApp" ng-controller="RoleMgmtController" >
 ...
 <fieldset ng-disabled="loading || showLoader">
    <div class="container">
        ...
        <div class="row marginBottom5px">
            <div class="col-sm-12">
                <h3 class="text-left" id="PageHeading">RP - Role Assignment</h3>
            </div>
        </div>	
        <div>
                        ...
                        <ng-form name="rpAccessControlForm" id="rpAccessControlForm" >
                            <div class="panel panel-info ">
                                <div class="panel-heading panelHeadingStyle">
                                    <div class="row ">
										<label class="control-label col-sm-10 ">User Role Assignment</label>
									</div>
                                </div>
                                <div class="panel-body">
                                 ...
                                 <label class="control-label col-sm-2 textAlignRight">GFT User</label>
                                    ...
                                    <div id="divRoleDetails" class="row marginBottom5px" >
                                     	<label class="control-label col-sm-1 textAlignRight required-Field">RightPrice roles</label>
                                        <div class="col-sm-4">
                                        <select class="form-control" name="ddlRolesSelectFrom" id="ddlRolesSelectFrom" ng-model="selectedAvailItems"
										    	multiple size="10" ng-options="emd.role.rolename for emd in roles">									    	
										    </select>
                                        </div>
                                     	<div class="col-sm-3 text-center" style="padding:50px;">
										   <button type="button" class="btn btn-primary btnWidth79px" id="btnAdd" ng-click="btnRight($index);disableButton()" ng-disabled="if(selectedAvailItems.length)">Add</button>
										     <div class="divEmpty"></div>
									 	...
									 	<div class="col-sm-4 col-xs-4">
										    ...
										    multiple size="10" ng-options="sil.role.rolename for sil in selectedItemList ">
										    </select>
										 </div> 
                                    </div>
									<div class="divEmptyThrice"></div>
                                    <div class="row text-center">
										<div class="col-sm-12">		
											<button type="button" class="btn btn-primary btnSpace" id="btnAddSave" ng-disabled="saveDisable" ng-click="addRProleData();">Save</button>						
