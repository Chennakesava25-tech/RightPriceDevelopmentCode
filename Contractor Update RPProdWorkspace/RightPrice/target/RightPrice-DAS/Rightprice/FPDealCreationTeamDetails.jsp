...
// 		var app = angular.module('FPDealCreationTeamDetailsApp', []);
		app.controller("FPDealCreationTeamDetailsController", ['$scope','$http','$window', function($scope,$http,$window,$index) {
			$scope.Prev = function() 
		    {   
...
<body ng-app="RightPriceApp" ng-controller="FPDealCreationTeamDetailsController" >
   ...
   <fieldset ng-disabled="loading || showLoader">
    <div class="container">
        ...
        <div class="row marginBottom5px">
            <div class="col-sm-12">
                <h3 class="text-left">FP Deal Creation - Team Details</h3>
            </div>
        </div>	
        <div>
