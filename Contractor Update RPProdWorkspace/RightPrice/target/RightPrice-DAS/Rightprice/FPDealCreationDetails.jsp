...
<script
	...
	<script src="${contextPath}/resources/js/RightPrice/fpDealCreationDetails.js"></script>
	<script src="${contextPath}/resources/js/Factory/WebServiceFactory.js"></script>	
	
    <!-- <script type="text/javascript">
    	
		var app = angular.module('RightPrice', []);
		app.controller("CreateDealDetailsController", ['$scope','$location','$anchorScroll','$http','$window', function($scope,$location,$anchorScroll,$http,$window,$index){
			 $scope.Next = function()
		    {   
...
<body ng-app="RightPriceApp" ng-controller="CreateDealDetailsController" ng-init="currentUser('<%=session.getAttribute("user")%>')">
<%-- <body ng-app="RightPriceApp" ng-controller="CreateDealDetailsController" ng-init="currentUser('<%=org.springframework.security.core.context.SecurityContextHolder.getContext().getAuthentication().getName()%>')"> --%>
    ...
    <div class="container">
        ...
        <div class="row marginBottom5px">
            <div class="col-sm-12">
                <h3 class="text-left" id="PageHeading">FP Deal Creation - Details</h3>
            </div>
        </div>	
        <div>
            <form class="form-inline" role="form" name="frmDeal" id="frmDeal" novalidate>
	            	<div id="includedT&PStages" ng-if="fpdealnormal" ng-include="'${contextPath}/Portal/FPdealCompletionStage.jsp'"></div>
	              	<div id="includedT&PStages" ng-if="fpdealmanual" ng-include="'${contextPath}/Portal/FPdealManualCompletionStage.jsp'"></div>
	           	<div id="DealCreationDetails" ng-include="'${contextPath}/Rightprice/DealCreationDetails.jsp'"></div>
	      	</form>
        </div>
    </div>
    </fieldset>
